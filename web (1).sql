...
--
-- Host: localhost
-- Generation Time: Jan 07, 2025 at 01:19 AM
...
--
ALTER TABLE `allergens`
  MODIFY `id_allergen` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `allergen_product`
--
ALTER TABLE `allergen_product`
  MODIFY `id_allergen_product` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
